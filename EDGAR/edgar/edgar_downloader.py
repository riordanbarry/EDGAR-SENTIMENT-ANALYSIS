...
def write_page(url,file_path):
    """Writes the html data from a given url to a file_path """ 

    #Headers provided to meet security requirements
...
def download_files_10k(ticker, dest_folder):
    """ For an S&P100 ticker, returns html downloads of all available 10-K reports """
